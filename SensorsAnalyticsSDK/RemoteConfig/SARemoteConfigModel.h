...
@protocol SARemoteConfigProtocol <NSObject>
...
@interface SARemoteMainConfigModel : NSObject <SARemoteConfigProtocol>
...
@interface SARemoteEventConfigModel : NSObject <SARemoteConfigProtocol>
...
@interface SARemoteConfigModel : NSObject <SARemoteConfigProtocol>
