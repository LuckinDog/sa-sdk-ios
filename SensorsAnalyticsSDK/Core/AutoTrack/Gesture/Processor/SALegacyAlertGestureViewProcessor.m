//
// SALegacyAlertGestureViewProcessor.m
// SensorsAnalyticsSDK
//
...
- (UIView *)trackableViewWithGesture:(UIGestureRecognizer *)gesture {
    NSArray <UIView *>*visualViews = [self searchVisualSubViewWithType:@"_UIAlertControllerCollectionViewCell" fromView:gesture.view];
