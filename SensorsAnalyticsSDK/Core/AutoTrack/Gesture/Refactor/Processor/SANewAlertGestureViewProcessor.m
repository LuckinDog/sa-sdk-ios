//
// SANewAlertGestureViewProcessor.m
// SensorsAnalyticsSDK
//
...
- (UIView *)trackableViewWithGesture:(UIGestureRecognizer *)gesture {
    NSArray <UIView *>*visualViews = [self searchVisualSubViewWithType:@"_UIInterfaceActionCustomViewRepresentationView" fromView:gesture.view];
