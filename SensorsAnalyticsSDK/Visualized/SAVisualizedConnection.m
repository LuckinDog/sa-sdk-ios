...
- (void)sendMessage:(id<SAVisualizedMessage>)message {
    if (_connected) {
        ...
        NSURLSessionDataTask *task = [[SensorsAnalyticsSDK sharedInstance].session dataTaskWithRequest:request completionHandler:^(NSData *_Nullable data, NSHTTPURLResponse *_Nullable response, NSError *_Nullable error) {
