...
- (void)testSensorsdataHashCode {
    ...
    XCTAssertTrue(equele1 && different1 && equele2 && different2 && equele3);
}
...
// strlen 隐含高危漏洞，改为 strnlen
    ...
    XCTAssertTrue(emptyEquele1 && letterEquele1 && endEquele1 && cnEquele1 && arrayEquele1 && arrayEquele2);
}
...
// memcpy 隐含高危漏洞，改为 strlcpy
    ...
    XCTAssertTrue(emptyEquele1 && letterEquele1 && endEmptyEquele1);
}
