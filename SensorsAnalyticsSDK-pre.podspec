Pod::Spec.new do |s|
  ...
  s.subspec 'core' do |c|
    c.source_files  =  "SensorsAnalyticsSDK/*.{h,m}", "SensorsAnalyticsSDK/Visualized/*.{h,m}", "SensorsAnalyticsSDK/HeatMap/*.{h,m}", "SensorsAnalyticsSDK/VisualizedAutoTrack/*.{h,m}", "SensorsAnalyticsSDK/JSBridge/*.{h,m}"
